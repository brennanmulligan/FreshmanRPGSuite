...
/**
 * If a player has buff points, they should get a bonus in their knowledge points.
 *
 * @author Adam Pine, Truc Chau, Andy Kim
 */
public class QuiznasiumGrantsKnowledgePointsWithBuffSequenceTest extends SequenceTest
{
	...
	private MessageFlow[] sequence = new MessageFlow[]{
			...
			new MessageFlow(ServerType.AREA_SERVER, ServerType.THIS_PLAYER_CLIENT,
					new KnowledgeChangedMessage(PlayersForTest.JEFF.getPlayerID(),
							PlayersForTest.JEFF.getKnowledgeScore() + 2, PlayersForTest.JEFF.getBuffPool() - 1),
					false)
	 ...
	 */
	public QuiznasiumGrantsKnowledgePointsWithBuffSequenceTest()
	{
	...
	public void setUpMachines() throws DatabaseException
	{
		...
		OptionsManager.getSingleton().setMapName("quiznasium.tmx");
