...
public class ObjectiveRowDataGatewayRDS implements ObjectiveRowDataGateway
{
	 ...
	 */
	public ObjectiveRowDataGatewayRDS(int questId, int objectiveID) throws DatabaseException
	{
		...
		{
			throw new DatabaseException("Couldn't find an objective with ID " + this.objectiveID, e);
		}
	}
	 ...
	 */
	public ObjectiveRowDataGatewayRDS(int objectiveID, String objectiveDescription, int questId,
									  ...
									  ObjectiveCompletionCriteria objectiveCompletionCriteria) throws DatabaseException
	{
		...
		{
			throw new DatabaseException("Couldn't create and objective record for objective with "
					+ "objective ID of " + objectiveID + " and quest ID of " + questId, e);
		}
	}
	...
	public ObjectiveRowDataGatewayRDS(String objectiveDescription, int questId,
									  ...
									  ObjectiveCompletionCriteria objectiveCompletionCriteria) throws DatabaseException
	{
		this(ObjectiveTableDataGatewayRDS.getSingleton().getNextObjectiveID(questId),
				objectiveDescription, questId, experiencePointsGained, objectiveCompletionType,
	...
	public void removeObjective() throws DatabaseException
	{
		...
		{
			throw new DatabaseException("Unable to remove objective with ID " + this.objectiveID, e);
		}
	}
	...
	public void persist() throws DatabaseException
	{
		...
		{
			throw new DatabaseException("Couldn't update the objective record for objective with "
					+ "objective ID of " + objectiveID + " and quest ID of " + questId, e);
		}
