...
import model.CommandAddAdventure;
 ...
 *
 */
public class AddAdventureModal extends Modal
{

	private static AddAdventureModal instance;
	 ...
	 */
	private AddAdventureModal(String id, String label, int height, int width)
	{
		...
		addAdventureBox.getChildren().addAll(
				...
				this.generateElement("Adventure Type:", adventureCompletionType),
	...
	public void save()
	{
		AddAdventureModal modal = AddAdventureModal.getInstance();
		CommandAddAdventure command = null;
		...
		command = new CommandAddAdventure(quest.getQuestID(), adventureDescription, xpAmount, completionType, criteria);
	 ...
	 * @return the instance
	 */
	public static AddAdventureModal getInstance()
	{
		if (instance == null)
		{
			instance = new AddAdventureModal("AddAdventureModal", "Add Adventure", 400, 620);
		}
		return instance;
	}
