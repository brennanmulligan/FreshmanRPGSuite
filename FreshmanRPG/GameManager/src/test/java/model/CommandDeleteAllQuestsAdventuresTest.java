...
/**
 * Tests for command to delete all quests and adventures  in tables before importing.
 * @author Jordan Long
 *
 */
public class CommandDeleteAllQuestsAdventuresTest
{
	 ...
	 */
	@Test
	public void deleteAllQuestsAdventures() throws DatabaseException
	{
		...
		assertEquals(0, questManager.getNumberOfQuests());
