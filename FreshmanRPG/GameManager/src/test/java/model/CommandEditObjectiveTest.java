...
/**
 * @author Darin Alleman and Darnell Martin Tests for the Edit Objective command
 ...
 *
 */
public class CommandEditObjectiveTest extends DatabaseTest
{
	 ...
	 * command is executed as well as that the list contains the edited objective.
	 *
	 * @throws DatabaseException
	 *             shouldn't
	 */
	@Test
	public void testEditObjective() throws DatabaseException
	{
		ObjectivesForTest objective = ObjectivesForTest.QUEST1_OBJECTIVE_1;
		CommandEditObjective cmd = new CommandEditObjective(objective.getQuestID(), objective.getObjectiveID(),
				objective.getObjectiveDescription(), 100, objective.getCompletionType(),
		...
		assertEquals(100, afterObjective.getExperiencePointsGained());
	...
	public void testReportIsSent() throws DatabaseException
	{
		...
		AllQuestsAndObjectivesReport reportReceived = (AllQuestsAndObjectivesReport) obs.getReport();
