...
/**
 * Tests AllQuestsAndAdventuresReport - pretty simple since it is just a data transfer
 * object
 *
 * @author Darnell Martin & Darin Alleman
 *
 */
public class AllQuestsAndAdventuresReportTest
{
	...
	/**
	 * Even an empty list of Quests and Adventures should not be null
	 */
	@Test
	public void testEmpty()
	{
		AllQuestsAndAdventuresReport r = new AllQuestsAndAdventuresReport(new ArrayList<>());
	...
	public void testNotEmpty() throws DatabaseException
	{
		...
		QuestRecord p1 = new QuestRecord(t.getQuestID(), t.getQuestTitle(), t.getQuestDescription(),
				...
				t.getAdventuresForFulfillment(), t.getCompletionActionType(),
		...
		QuestRecord p2 = new QuestRecord(t.getQuestID(), t.getQuestTitle(), t.getQuestDescription(),
				...
				t.getAdventuresForFulfillment(), t.getCompletionActionType(),
				t.getCompletionActionParameter(), t.getStartDate(), t.getEndDate());
		AllQuestsAndAdventuresReport r = new AllQuestsAndAdventuresReport(list);
		list.add(p1);
		list.add(p2);
		ArrayList<QuestRecord> a = r.getQuestInfo();
