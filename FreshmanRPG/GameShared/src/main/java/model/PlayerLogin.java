...
public class PlayerLogin
{
	...
	private PlayerLoginRowDataGateway loginGateway;
	 ...
	 */
	protected PlayerLogin(int playerID, String name, String password, int id) throws DatabaseException
	{
		try
		{
			if (OptionsManager.getSingleton().isUsingMockDataSource())
			{
				this.loginGateway = new PlayerLoginRowDataGatewayMock(playerID, name, password);
			}
			else
			{
				this.loginGateway = new PlayerLoginRowDataGatewayRDS(playerID, name, password);
			}
		}
	...
	protected PlayerLogin(String playerName, String password) throws DatabaseException
	{
		try
		{
			if (OptionsManager.getSingleton().isUsingMockDataSource())
			{
				this.loginGateway = new PlayerLoginRowDataGatewayMock(playerName);
				this.playerGateway = new PlayerRowDataGatewayMock(loginGateway.getPlayerID());
			}
			else
			{
				this.loginGateway = new PlayerLoginRowDataGatewayRDS(playerName);
				this.playerGateway = new PlayerRowDataGatewayRDS(loginGateway.getPlayerID());
			}
		}
		catch (DatabaseException e)
		{
	...
	protected PlayerLogin(int playerID) throws DatabaseException
	{
		try
		{
			if (OptionsManager.getSingleton().isUsingMockDataSource())
			{
				this.loginGateway = new PlayerLoginRowDataGatewayMock(playerID);
			}
			else
			{
				this.loginGateway = new PlayerLoginRowDataGatewayRDS(playerID);
			}
		}
		catch (DatabaseException e)
		{
	 ...
	 */
	public void editPlayeLogin(String playerName, String password) throws DatabaseException
	{
	...
	public boolean equals(Object obj)
	{
		...
		if (login.getPlayerName().equals(this.getPlayerName()) &&
