 ...
 *
 * This is the message class for the knowledge point prize message
 *
 */
public class KnowledgePointPrizeMessage implements Message, Serializable
{
	 ...
	 * @param dtos
	 */
	public KnowledgePointPrizeMessage(int playerID, ArrayList<KnowledgePointPrizeDTO> dtos)
	{
	...
	public boolean equals(Object obj)
	{
		...
		KnowledgePointPrizeMessage other = (KnowledgePointPrizeMessage) obj;
		if (dtos == null)
		{
			if (other.dtos != null)
			{
