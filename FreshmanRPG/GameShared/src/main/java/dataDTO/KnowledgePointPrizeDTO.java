 ...
 *
 * This class is the DTO that holds a knowledge point prize details
 *
 */

public class KnowledgePointPrizeDTO implements Serializable
{
	 ...
	 */
	public KnowledgePointPrizeDTO(String name, int cost, String description)
	{
		this.name = name;
		this.cost = cost;
	...
	public boolean equals(Object obj)
	{
		...
		KnowledgePointPrizeDTO other = (KnowledgePointPrizeDTO) obj;
		if (cost != other.cost)
		{
			return false;
		}
