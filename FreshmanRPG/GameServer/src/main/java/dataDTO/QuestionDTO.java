...
public class QuestionDTO
{
	...
	/**
	 * Create a new instance of QuestionInfo.
	 *
	 * @param id
	 *            question ID
	 * @param question
	 ...
	 * @param startDate
	 *            The starting valid date for a question
	 * @param endDate
	 *            The ending valid date for a question
	 */
	public QuestionDTO(int id, String question, String answer, LocalDate startDate, LocalDate endDate)
	{
		this.questionID = id;
	...
	/**
	 * @return answer The correct response to the question
	 */
	...
	{
		String s = "QuestionInfo(question: " + this.getQuestion() + ", answer: " + this.getAnswer() + ", startDate: "
