...
public final class ChatMessageReceivedReport implements Report
{
     ...
     */
    public ChatMessageReceivedReport(int senderID, int receiverID, String messageContent, Position pos, ChatType type)
    {
    ...
    public boolean equals(Object obj)
    {
        ...
        ChatMessageReceivedReport other = (ChatMessageReceivedReport) obj;
        if (location == null)
        {
