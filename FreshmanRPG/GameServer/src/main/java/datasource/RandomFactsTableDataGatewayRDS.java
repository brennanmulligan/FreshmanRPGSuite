 ...
 *
 */
public class RandomFactsTableDataGatewayRDS extends RandomFactsTableDataGateway
{

	private static RandomFactsTableDataGatewayRDS singleton;

	/**
	 * @return the one and only
	 */
	public static synchronized RandomFactsTableDataGatewayRDS getSingleton()
	{
		if (singleton == null)
		{
			singleton = new RandomFactsTableDataGatewayRDS();
		}
		return singleton;
	}
	 ...
	 */
	private RandomFactsTableDataGatewayRDS()
	{
