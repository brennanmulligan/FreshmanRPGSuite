...
public final class ObjectiveNeedingNotificationReport implements QualifiedObservableReport, NotificationTrigger
{
	 ...
	 * @param state
	 *            the state of the objective for this player
	 * @param realLifeObjective
	 *            true if the player must complete this objective in real life
	 * @param witnessTitle
	 *            if this is a real life objective, this will hold the title of
