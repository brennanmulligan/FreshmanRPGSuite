...
public class FriendsUI extends OverlayingScreen implements QualifiedObserver
{
	 ...
	 *            id of the friend whose messages are to be displayed on the right
	 *            side
	 */
