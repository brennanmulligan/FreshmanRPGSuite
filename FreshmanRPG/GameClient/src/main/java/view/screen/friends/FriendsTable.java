...
public class FriendsTable extends OverlayingScreenTable
{
	...
	/**
	 * @param friendList
	 *            the friends to display
	 * @param scrollable
	 *            whether or not the window can be scrolled
	 */
	...
	/**
	 * @param friendDTO
	 *            A friend to be added to the UI
	 ...
	 *
	 * @param friendList
	 *            The list of friends that the player has
	 */
