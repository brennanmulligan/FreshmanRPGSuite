...
public class SpriteSheet
{
	 ...
	 *
	 * @param tex
	 *            - texture region of a source texture file to divide up
	 * @param xFrames
	 *            - number of horizontal frames in the spritesheet
	 * @param yFrames
	 *            - number of vertical frames in the spritesheet
	 ...
	 *            - path to file
	 * @param xFrames
	 *            - number of horizontal cells in the spritesheet
	 * @param yFrames
	 *            - number of vertical cells in the spritesheet
	 */
	 ...
	 *
	 * @param row
	 *            - the row index to pick out of the spritesheet
	 ...
	 *
	 * @param col
	 *            - the column index of frames to pick out
	 ...
	 *
	 * @param frame
	 *            - frame index in the spritesheet (0...n-1)
	 * @param indexDirection
	 *            - true for down rows then next column, false for across
	 ...
	 *
	 * @param frame
	 *            - the frame index in the spritsheet (0...n-1)
